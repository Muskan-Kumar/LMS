...
const AddCourse = () => {
 ...
 const handleChapter = (action, chapterId)=>{
    if(action === 'add'){
      ...
      setChapters(chapters.filters((chapter)=>chapter.chapterId !== chapterId))
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
        <div className='flex flex-col gap-1'>
          ...
          <input onChange={e => setCourseTitle(e.target.value)} value={courseTitle} type="text" placeholder='Type here'
           className='outline-none md:pb-2.5 py-2 px-3 rounded border border-gray-500' required />
        </div>
        <div className='flex flex-col gap-1'>
        ...
        <div>
          {chapters.map((chapter, chapterIndex)=>(
            <div key={chapterIndex} clasName='bg-white border rounded-lg mb-4'>
              <div className='flex justify-between items-center p-4 border-b'>
                ...
                <img onClick={()=>handleChapter('remove',chapter.chapterId)} src={assets.cross_icon} 
          ...
          {showPopup && (
            <div className='fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50'>
              <div className='bg-white text-gray-700 p-4 rounded relative w-full max-w-80'>
                <h2 onClick={()=>handleChapter('add')} className='text-lg font-semibold mb-4'>Add Lecture</h2>
                ...
                <div className='mb-2'>
                  <p>Is Preview Free</p>
                  <input type="text" className='mt-1 block w-full border rounded py-1 px-2' value={lectureDetails.isPreviewFree}
                ...
                <img onClick={()=> setShowPopup(flase)} src={assets.cross_icon} alt="" 
